...
class BankiClient:
    """A class for interacting with the banki app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        BankiClient can be created with an app_id to interact with an existing application, alternatively
